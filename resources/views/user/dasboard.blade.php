...
<div class="row">
	<div class="col-md-8">
		<b class="label label-info"><b>EKONOMI</b></b>
		<hr>
		<div class="panel">
			<div class="panel">
				<!-- ekonomi -->
			...
			<!-- olahraga -->
			<br>
			<b class="label label-info"><b>OLAHRAGA </b></b>
			<hr>
			...
			<!-- politik -->
			<br>
			<b class="label label-info"><b>POLITIK</b></b>
			<hr>
			...
			<!-- tekonologi -->
			<br>
			<b class="label label-info"><b>TEKNOLOGI</b></b>
			<hr>
